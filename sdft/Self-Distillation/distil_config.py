...
class DistilConfig(TrainingArguments):
    ...
    max_total_length: Optional[int] = field(
        default=None,
        metadata={
            "help": "Maximum total length for student prompt plus generated completion. If unset, defaults to "
            "`max_prompt_length + max_completion_length` behavior."
        },
    )
    teacher_max_prompt_length: Optional[int] = field(
        default=None,
        metadata={
            "help": "Maximum length of the teacher prompt. If unset, defaults to `max_prompt_length`."
        },
    )
